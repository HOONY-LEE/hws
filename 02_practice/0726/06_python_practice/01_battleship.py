...
while True:
    ...
    if computer_sea[player_attack_index-1] == 0:
       pass     
    
    # 2-5) 컴퓨터의 공격 위치 지정

    while True :
        computer_attack_index = random.randrange(1, 16)
        if computer_attacked[computer_attack_index-1] == False:
